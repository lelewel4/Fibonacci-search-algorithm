...
HD_PWD='D:/SDUP_Fibonacci_Vivado/Projekt_mgr/Projekt_mgr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fibonacci_search.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fibonacci_search.tcl
